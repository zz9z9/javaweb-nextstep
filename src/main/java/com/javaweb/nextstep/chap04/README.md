...
public class LogicMapper {
    static Map<String, Method> getMappingUrl = new HashMap<>();
    static final Class userLogicClass = UserLogic.class;
    ...
    private void initGetRequest() {
        try {
            getMappingUrl.put("/user/create", userLogicClass.getMethod("signup", User.class));
    ...
    public <T> void executeMethodForRequest(T instance, String request) throws InvocationTargetException, IllegalAccessException {
        getMappingUrl.get(request).invoke(instance);
    }

    public <T> void executeMethodForRequest(T instance, String request, Object params) throws InvocationTargetException, IllegalAccessException {
        getMappingUrl.get(request).invoke(instance, params);
    }
}
```
### 배운 것
